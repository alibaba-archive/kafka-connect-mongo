...
connector.class=com.teambition.kafka.connect.mongo.source.MongoCronSourceConnector
tasks.max=1
mongo.uri=mongodb://127.0.0.1:27017
batch.size=100
schema.name=mongo_local_schema
...
connector.class=com.teambition.kafka.connect.mongo.sink.MongoSinkConnector
tasks.max=1
